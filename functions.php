...
function bigbang_scripts() {
	...
	wp_enqueue_script( 'bigbang-app', get_template_directory_uri() . '/assets/js/dist/app.min.js', '', '', true );

	wp_enqueue_script( 'bigbang-vendor', get_template_directory_uri() . '/assets/js/dist/vendor.min.js', '', '', true );
